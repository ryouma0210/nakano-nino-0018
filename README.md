...
- HPが0になる、または負けイベントを選ぶと、02画像で10セリフ、03画像で10セリフの誘惑イベントに入り、画像とコメントをタップ送りで切り替えます
- 誘惑イベント中は画像を大きく表示し、HP／MP／サキュバスHPバーは表示しません
- 負けイベント中は誘惑BGMへ切り替わり、5セリフ後からループ音、最後は射精音を再生します
