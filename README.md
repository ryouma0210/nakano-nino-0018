...
| 館の外へ | 家に帰るために外へ出る軽量RPG風ミニゲーム。ドア、自分、サキュバスを表示するドット風マップ、サキュバス誘惑バトル、HP/MP/欲望/服従ゲージを表示 |
...
- ドア、自分、サキュバスを表示するドット風マップ
- ドアを選ぶと二ノ様の控室へ戻る
- 上へ進むとサキュバスが近づき、一言表示して戦闘モードへ移行
- 選択肢による結果分岐
- サキュバス誘惑バトル
- HP、MP、欲望、服従、サキュバス集中ゲージ
- コマンド選択による成功／失敗判定
- ランダムイベント
- 会話イベント中は誘惑BGM、バトル中は戦闘BGMへ自動切り替え
- レベル帯に応じて相手のイラストと口調が変化
- 一日10レベル上昇、最大90レベル
- 誘惑カードでは「誘惑に耐える」「誘惑に負ける」「諦めて逃亡する」を選択
- 魅了状態になると3ターンの間、逃亡に失敗します
- 「誘惑に負ける」を選ぶと魅了状態になり、尻尾イベントでレベルが下がります
- 耳元で囁きイベント、または魅了時は耳舐め音声を再生します

登場サキュバス:

| 条件 | 相手 |
|---|---|
| Lv10付近 | ニノメスガキ初級サキュバス |
| 中盤 | 上級サキュバス |
| 高レベル | 女王サキュバス |
...
誘惑イベント用のイラストは、3段階×6種類で追加しています。探索マップ上はドット風表示のみ、戦闘時は人物イラストを表示します。
