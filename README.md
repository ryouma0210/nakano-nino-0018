...
| 敗北部屋 | 契約者限定。上部に専用画像、下に拡大可能な敗北動画、日付単位の強制チェック、専用音声、同心ハート演出、調教日記への保存 |
...
画面構成は、上部に敗北部屋用の二ノ画像、下にタップで拡大できる敗北動画、その下にチェック項目を配置します。ハート動画は背景演出として表示し、チェック操作の邪魔をしないようにしています。
