...
- リズムゲージ、効果音、ループ音声
- ポイント獲得、ご褒美交換、コレクション
- 二ノ様の控室での疑似Live2D表示、着せ替え、ボイス候補選択
...
| 二ノ様の控室 | 疑似Live2D風の専用画面。キャラ表示、セリフ、着せ替え、ボイス候補の試聴・選択 |
| 記録・管理メニュー | 週間報告、調教日記、ファイル格納、ループ音声、コレクション、ご褒美、マイページ、設定への入口 |
